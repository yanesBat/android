...
export class PhoneNumberComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.phoneNumberService
            ...
            .subscribe(
                (res: HttpResponse<IPhoneNumber[]>) => this.paginatePhoneNumbers(res.body, res.headers),
    ...
    trackId(index: number, item: IPhoneNumber) {
        return item.id;
    }
    ...
    protected paginatePhoneNumbers(data: IPhoneNumber[], headers: HttpHeaders) {
