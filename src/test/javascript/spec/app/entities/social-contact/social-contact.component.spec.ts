...
import { SocialContactComponent } from 'app/entities/social-contact/social-contact.component';
...
describe('Component Tests', () => {
    describe('SocialContact Management Component', () => {
        let comp: SocialContactComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SocialContactComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.socialContacts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
